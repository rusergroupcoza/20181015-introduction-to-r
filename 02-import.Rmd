...
exchange_rates <- read.csv("data/ZAR_USD_Exchange_Rate_Detail_2000_to_2018-10-08.csv") # import all ZAR USD exchange rates from 2000 to 2018-10-08
exchange_rates <- exchange_rates %>% filter(Year == 2018 ) # import 2018 exchange rates
head(exchange_rates) # view first 6 values
summary(exchange_rates$Value) # summary statistics of Value field
```
